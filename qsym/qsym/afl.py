...
class AFLExecutor(object):
    def __init__(self, cmd, output, afl, name, filename=None, mail=None, asan_bin=None, qemu_mode=None, afl_path=None):
        self.cmd = cmd
        self.output = output
        self.afl = afl
        self.name = name
        ...
        cmd, _afl_path, _qemu_mode = self.parse_fuzzer_stats()
        if afl_path is None:
            afl_path = _afl_path
        if qemu_mode is None:
